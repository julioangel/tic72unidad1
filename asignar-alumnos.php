    ...
    for($x=0; $x<$alumnos; $x++)
     {
        ...
        /* echo"$sql04 sql04 <br>";
         ...
         if($accion==5)
         {
             ...
             echo"<META HTTP-EQUIV=REFRESH CONTENT=0.5;URL=http://localhost/tic72unidad1/asignar-alumnos.php>";
...
echo"accion6";
   $idalumnoborrar=$_REQUEST['idalumno'];
    echo"$idalumnoborrar";
       $grupoobj->borrar_alumno_grupo($idalumnoborrar);
    echo"<META HTTP-EQUIV=REFRESH CONTENT=1;URL=http://localhost/tic72unidad1/asignar-alumnos.php>";
}
